...
sc1 = Separator(window,orient=VERTICAL)
sc2 = Separator(window,orient=VERTICAL)
sr1 = Separator(window,orient=HORIZONTAL)
sr2 = Separator(window,orient=HORIZONTAL)
MAINSEP = Separator(window, orient=VERTICAL)
sr3 = Separator(window,orient=HORIZONTAL)
sr4 = Separator(window,orient=HORIZONTAL)
# THE GRID
solveBtn.grid(row=10,column=9,columnspan=3)
scanBtn.grid(row=10,column=6,columnspan=3)
sr1.place(x=46,y=0,height=189,width=3)
sr2.place(x=94,y=0,height=189,width=3)
sr3.place(x=202,y=0,height=189,width=3)
sr4.place(x=262,y=0,height=189,width=3)
sc1.place(x=0,y=63,relwidth=1.0,height=3)
sc2.place(x=0,y=126,relwidth=1.0,height=3)
MAINSEP.place(x=140,y=0,height=189,width=5)
